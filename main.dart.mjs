...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1336: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1345: (x0,x1) => x0.end(x1),
      _1346: x0 => x0.pause(),
      _1347: x0 => x0.play(),
      _1348: x0 => x0.load(),
      _1349: (x0,x1) => x0.setSinkId(x1),
      _1357: (x0,x1) => x0.getItem(x1),
      _1358: (x0,x1) => x0.removeItem(x1),
      _1359: (x0,x1,x2) => x0.setItem(x1,x2),
      _1360: (x0,x1) => x0.querySelector(x1),
      _1361: x0 => ({type: x0}),
      _1362: (x0,x1) => new Blob(x0,x1),
      _1363: x0 => globalThis.URL.createObjectURL(x0),
      _1364: (x0,x1) => x0.item(x1),
      _1365: () => new FileReader(),
      _1367: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1368: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1368(f,arguments.length,x0) }),
      _1369: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1373: (x0,x1) => x0.removeChild(x1),
      _1375: x0 => globalThis.URL.revokeObjectURL(x0),
      _1377: (x0,x1) => x0.has(x1),
      _1378: (x0,x1) => x0.open(x1),
      _1379: x0 => x0.keys(),
      _1380: (x0,x1) => x0.match(x1),
      _1381: x0 => x0.arrayBuffer(),
      _1382: (x0,x1) => x0.delete(x1),
      ...
      _1387: (x0,x1,x2) => x0.open(x1,x2),
      _1388: (x0,x1) => x0.contains(x1),
      _1389: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1393: x0 => x0.persisted(),
      _1394: x0 => x0.persist(),
      _1395: x0 => x0.estimate(),
      ...
      _1398: (x0,x1,x2) => x0.transaction(x1,x2),
      _1399: (x0,x1) => x0.objectStore(x1),
      _1400: (x0,x1,x2) => x0.put(x1,x2),
      _1401: (x0,x1) => x0.get(x1),
      _1402: (x0,x1) => x0.delete(x1),
      _1403: x0 => x0.openCursor(),
      _1404: x0 => x0.continue(),
      ...
      _1413: () => typeof dartUseDateNowForTicks !== "undefined",
      _1414: () => 1000 * performance.now(),
      _1415: () => Date.now(),
      _1416: () => {
      ...
      _1418: () => new WeakMap(),
      _1419: (map, o) => map.get(o),
      _1420: (map, o, v) => map.set(o, v),
      _1421: x0 => new WeakRef(x0),
      _1422: x0 => x0.deref(),
      _1429: () => globalThis.WeakRef,
      _1433: s => JSON.stringify(s),
      _1434: s => printToConsole(s),
      _1435: o => {
        if (o === null || o === undefined) return 0;
        if (typeof(o) === 'string') return 1;
        return 2;
      },
      _1436: (o, p, r) => o.replaceAll(p, () => r),
      _1437: (o, p, r) => o.replace(p, () => r),
      _1438: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1439: s => s.toUpperCase(),
      _1440: s => s.trim(),
      _1441: s => s.trimLeft(),
      _1442: s => s.trimRight(),
      _1443: (string, times) => string.repeat(times),
      _1444: Function.prototype.call.bind(String.prototype.indexOf),
      _1445: (s, p, i) => s.lastIndexOf(p, i),
      _1446: (string, token) => string.split(token),
      _1447: Object.is,
      _1452: (o, c) => o instanceof c,
      _1453: o => Object.keys(o),
      _1457: (o, a) => o + a,
      ...
      _1673: (x0,x1) => x0.append(x1),
      _1674: (x0,x1) => x0.matchMedia(x1),
      _1675: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1675(f,arguments.length,x0) }),
      _1676: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1676(f,arguments.length,x0) }),
      _1677: (x0,x1) => x0.canPlayType(x1),
      _1678: (x0,x1,x2) => new OfflineAudioContext(x0,x1,x2),
      _1679: (x0,x1) => x0.decodeAudioData(x1),
      _1680: (x0,x1) => x0.getChannelData(x1),
      _1681: (x0,x1) => x0.key(x1),
      _1682: o => o instanceof Array,
      _1686: a => a.pop(),
      _1687: (a, i) => a.splice(i, 1),
      _1688: (a, s) => a.join(s),
      _1689: (a, s, e) => a.slice(s, e),
      _1691: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1692: a => a.length,
      ...
      _1698: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1701: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1702: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _1703: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1704: o => o instanceof Uint8ClampedArray,
      _1705: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1706: o => o instanceof Uint16Array,
      _1707: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1708: o => o instanceof Int16Array,
      _1709: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1710: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _1711: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1712: o => {
        if (o === null || o === undefined) return 0;
      ...
      _1719: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1720: (a, i) => a.push(i),
      _1721: (t, s) => t.set(s),
      _1722: l => new DataView(new ArrayBuffer(l)),
      _1723: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1724: o => o.byteLength,
      _1725: o => o.buffer,
      _1726: o => o.byteOffset,
      _1727: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1728: (b, o) => new DataView(b, o),
      _1729: (b, o, l) => new DataView(b, o, l),
      _1730: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1731: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1732: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1733: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1734: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1735: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1736: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1737: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1738: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1739: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1740: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1741: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1744: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1745: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1746: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1747: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1748: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1749: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1750: Function.prototype.call.bind(Number.prototype.toString),
      _1751: Function.prototype.call.bind(BigInt.prototype.toString),
      _1752: Function.prototype.call.bind(Number.prototype.toString),
      _1753: (d, digits) => d.toFixed(digits),
      _1771: () => globalThis.console,
      _1810: (x0,x1) => x0.error(x1),
      _1927: (x0,x1) => { x0.draggable = x1 },
      _1943: x0 => x0.style,
      _2302: (x0,x1) => { x0.download = x1 },
      _2327: (x0,x1) => { x0.href = x1 },
      _2544: x0 => x0.error,
      _2545: x0 => x0.src,
      _2546: (x0,x1) => { x0.src = x1 },
      _2554: (x0,x1) => { x0.preload = x1 },
      _2555: x0 => x0.buffered,
      _2558: x0 => x0.currentTime,
      _2559: (x0,x1) => { x0.currentTime = x1 },
      _2560: x0 => x0.duration,
      _2565: (x0,x1) => { x0.playbackRate = x1 },
      _2578: (x0,x1) => { x0.volume = x1 },
      _2595: x0 => x0.code,
      _2596: x0 => x0.message,
      _2670: x0 => x0.length,
      ...
      _3627: x0 => x0.files,
      _3639: x0 => x0.dataTransfer,
      _3643: () => globalThis.window,
      _3704: x0 => x0.navigator,
      _3961: x0 => x0.indexedDB,
      _3965: x0 => x0.caches,
      _3968: x0 => x0.localStorage,
      _4076: x0 => x0.mediaSession,
      _4078: x0 => x0.maxTouchPoints,
      _4091: x0 => x0.userAgent,
      _4104: x0 => x0.storage,
      _4299: x0 => x0.length,
      _5748: x0 => x0.length,
      _6303: x0 => x0.firstChild,
      _6314: () => globalThis.document,
      _6396: x0 => x0.body,
      _6728: (x0,x1) => { x0.id = x1 },
      _6755: x0 => x0.children,
      _8246: x0 => x0.usage,
      _8248: x0 => x0.quota,
      _8253: x0 => x0.size,
      _8254: x0 => x0.type,
